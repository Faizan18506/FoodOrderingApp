...
import com.example.foodorderingapp.presentation.components.FoodCategoryTab
import com.example.foodorderingapp.presentation.components.TopAppBarDeliveryScreen
import com.example.foodorderingapp.presentation.screens.CategoryScreen.AllCategoryScreen
import com.example.foodorderingapp.presentation.screens.CategoryScreen.ChineseCategoryScreen
import com.example.foodorderingapp.presentation.screens.CategoryScreen.PizzaCategoryScreen
...
fun DeliveryScreen(navController: NavController, listState: LazyListState) {
    var selectedTabIndex by rememberSaveable { mutableIntStateOf(value = 0) }
